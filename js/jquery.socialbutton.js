...
function socialbutton_facebook_share(target, options, defaults, index, max_index)
{
	...
	if(index == 0) {
		tag += '<script type="text/javascript" src="' + PRTCL + '//static.ak.fbcdn.net/connect.php/js/FB.Share"></script>';
	}
...
function socialbutton_twitter(target, options, defaults, index, max_index)
{
	...
	if (index == max_index) {
		$('body').append('<script type="text/javascript" src="' + PRTCL + '//platform.twitter.com/widgets.js"></script>');
	}
}
...
function socialbutton_hatena(target, options, defaults, index, max_index)
{
	...
	var tag = '<a' + attr + '><img src="' + PRTCL + '//b.st-hatena.com/images/entry-button/button-only.gif" alt="このエントリーをはてなブックマークに追加" width="20" height="20" style="border: none;" /></a>'
			+ '<script type="text/javascript" src="' + PRTCL + '//b.st-hatena.com/js/bookmark_button.js" charset="utf-8" async="async"></script>';
...
function socialbutton_google_plusone(target, options, defaults, index, max_index)
{
	...
	if (index == max_index) {
		...
		if (typeof gapi === 'undefined' || typeof gapi.plusone === 'undefined') {
			$('body').append('<script type="text/javascript" src="' + PRTCL + '//apis.google.com/js/plusone.js">' + script_params + '</script>');
		} else {
			gapi.plusone.go();
		}
	}
...
function socialbutton_pinterest(target, options, defaults, index, max_index)
{
	...
	if (index == max_index) {
		$('body').append('<script type="text/javascript" src="' + PRTCL + '//assets.pinterest.com/js/pinit.js"></script>');
	}
}
...
function socialbutton_pocket(target, options, defaults, index, max_index)
{
	...
	var tag = '<a data-pocket-label="pocket" data-width="100px" data-save-url="' + url + '" data-pocket-count="' + counter + '" class="pocket-btn" data-lang="en"></a>';
...
function socialbutton_tumblr(target, options, defaults, index, max_index)
{
	...
	var tag = '<a id="tumblr-a" href="' + PRTCL + '//www.tumblr.com/share" title="Share on Tumblr" style="display:inline-block; text-indent:-9999px; overflow:hidden; '
			+ 'width:'+w+'px; height:'+h+'px; background:url(\'' + PRTCL + '//platform.tumblr.com/v1/share_' + button + '.png\') top left no-repeat transparent;">Share on Tumblr</a>';

	$(target).html(tag);

	if (index == max_index) {
		$('body').append('<script src="' + PRTCL + '//platform.tumblr.com/v1/share.js"></script>');
	}
}
...
function socialbutton_line(target, options, defaults, index, max_index)
{
	...
	var url = options.url || defaults.url;
	var w = 82, h = 20;
	var dataUrl = url_encode_rfc3986(decodeURIComponent(title+'\n'+url));
	...
	if (button == 'a' && lang == 'en') w = 78;

	var tag = '<a href="http://line.me/R/msg/text/?' + dataUrl + '">'
			+ '<img src="' + PRTCL + '//media.line.me/img/button/' + lang + '/'+w+'x'+h+'.png" width="'+w+'" height="'+h+'" alt="LINE it" /></a>';
